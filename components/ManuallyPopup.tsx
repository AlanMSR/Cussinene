...
const ManuallyPopup = ({ visible, onClose, onSave, userAttributes }: ManuallyPopupProps) => {
        ...
        >
          <View style={[styles.modalView, { backgroundColor: colors.surface }]}>
            <View style={styles.headerRow}>
              <ThemedText type="title" style={[styles.title, { color: colors.textPrimary, fontSize: getFontSize(20) }]}>Add item</ThemedText>
